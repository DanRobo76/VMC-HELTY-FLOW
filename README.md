...
VMC HELTY FLOW PLUS sviluppato per Home Assistant
  - VMC HELTY FLOW Release 08-05-2023 
  - Scheda Interfaccia Release 08-05-2023
  - Automazione Release 86-05-2023
...
#
<strong><a href="https://github.com/DanRobo76/VMC-HELTY-FLOW/blob/main/SECURITY.md" text="Limiti del SoftWare">Limiti del SoftWare</a></strong> 
#
...
<strong>8</strong> Nella Scheda Interfaccia, Cliccare su "Settaggi":<BR>
  ...
  <strong>8.4</strong> Impostare un "Set Lim. Δ Punto di Rugiada", solitamente a 5<BR>
  ...
  <strong>8.8</strong> Verificare con strumenti esterni se i Sensori di Temperatura Esterna, Temperatura Interna, Umidità Esterna, Umidità Interna, CO2 e VOC necessitano dell'Offset, diversamente portare uno o più sensori su 0<BR>
