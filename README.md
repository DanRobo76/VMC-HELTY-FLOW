...
<strong>Punti di Forza:</strong>
  ...
  - Spegne la VMC in funzione dei Parametri Ambientali<br>
    ...
    Se la differenza del PdR Ext. - PdR Int. è minore di almeno 3-4°C (Valore impostabile dal Cliente) garantisce un adeguato trasporto dell'umidità dall'interno all'esterno dell'edificio.<br>
    Diversamente se la differenza del PdR Ext. - PdR Int. è maggiore o uguale al "Set Lim. Δ Punto di Rugiada", la VMC si arresterà, per poi riprendere in autonomia, l'ultima velocità impostata.
